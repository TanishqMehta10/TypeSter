...
import { Code2, Mail, Lock, ArrowLeft, AlertCircle, Eye, EyeOff } from 'lucide-react';
...
export default function LoginPage({ onBack, onSignupClick, onSuccess }: LoginPageProps) {
      ...
      <div className="max-w-md w-full">
        ...
        <div className="bg-slate-800 rounded-2xl shadow-2xl p-8 border border-slate-700">
          <div className="text-center mb-8">
            ...
            <p className="text-slate-400">Login to continue your coding journey</p>
          </div>
        ...
        <div className="mt-6 text-center">
          <p className="text-slate-500 text-sm">
            By logging in, you agree to practice coding responsibly
          </p>
        </div>
      </div>
    </div>
